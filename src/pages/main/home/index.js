        ...
        return (
          <div className="bg-dark home">
            <div className="container">
              ...
              <content>
                <h2 className="text-white mb-3">Data Covid Tiap Negara</h2>
                <table className="table col-md-5 mb-5 table-hover">
                  <thead>
                    <tr>
                      <th scope="col" className="text-white">No</th>
                      <th scope="col" className="text-white">Contries</th>
                    </tr>
                  </thead>
                  <tbody>
                    {this.state.allContries.map((item, index) => (
